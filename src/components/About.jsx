...
function About() {
    return (
        <section id="about">
            ...
            <p>Mitt namn är Jeanette Samuelsson, jag är 32 år gammal och bor i Uddevalla tillsammans med min familj. Jag är tidigare biomedicinsk analytiker och har arbetat inom yrket sedan jag blev klar med utbildningen 2016. </p>
